...
**Series Path:** [@CKS-0-2026] → [@CKS-MATH-0-2026] → [@CKS-MATH-1-2026] → [@CKS-MATH-10-2026] → [@CKS-MATH-104-2026] → [@CKS-BIO-1-2026] → [@CKS-BIO-7-2026] → [@CKS-BIO-8-2026]  

**Zenodo DOI:** 10.5281/zenodo.18640413
...
```bibtex
@article{ CKS-0-2026,
  title={ The Eyes as X↔K Coordinators },
