...
```
Word cycle: 1/32 Hz = 31.25ms
Half cycle: 31.25/2 = 15.625ms
...
```
Nyquist theorem:
  Must sample at 2× data rate
  To avoid aliasing
  
Spine sampling:
  Substrate at 1/32 Hz
  Spine at 2/32 Hz = 1/16 Hz
  Period = 16ms
...
**The formula:**
```
Q = Energy_stored / Energy_dissipated_per_cycle
