...
- Mechanical energy → substrate displacement
...
**Pre-trauma:**
```
Proprioceptive field: Continuous gradient A→B→C→D
...
**Post-trauma:**
```
Proprioceptive field: A→[EGREGOR]→D
...
- Prediction: High coherence = active egregor
...
- Frozen shoulder (cannot abduct >30°)
...
□ Mechanism consistent with egregor?
...
**Date competency achieved:** _______________
...
Patient: _______________ (initials only)
Age/Sex: _______________

MECHANISM:
Impact type: _______________
Location: _______________
Estimated force: _______________
Time since injury: _______________

PRESENTATION:
Functional impairment: _______________
Pain level (0-10): _______________
Swelling (Y/N): _______________
Red flags (Y/N): _______________
...
INTERVENTION:
Technique used: _______________
Duration: _______________ seconds
Pressure: Light / Moderate / Firm
Frequency: _______________ Hz

OUTCOME:
Improvement at 60s: _______________
Improvement at 3 min: _______________
Improvement at 5 min: _______________
Return to activity: Y / N
Follow-up status: _______________
