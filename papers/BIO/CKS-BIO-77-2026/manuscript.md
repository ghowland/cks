...
Calculate:
T_9 = ([9,1,0]/[7,1,0]) × [192541,25000,0] × (1-φ)
    = [9,7,0] × [192541,25000,0] × (1-φ)
    = [1732869,175000,0] × (1-φ)
    ≈ [9.902,1,0] × (1-φ)

EXAMPLES:

At φ=0.99:
T_9 = [9.902,1,0] × [1,100,0]
    = [9902,10000,0]
    ≈ [0.99,1,0]
Minimal tension (manageable)

At φ=0.50:
T_9 = [9.902,1,0] × [50,100,0]
    = [49510,10000,0]
    ≈ [4.95,1,0]
Moderate tension (stress)

At φ=0.167:
T_9 = [9.902,1,0] × [833,1000,0]
    = [8248166,1000000,0]
    ≈ [8.25,1,0]
...
I_6 = [16,1,0] × [0.833,1,0] = [13.3,1,0]
T_9 = [9.9,1,0] × [0.833,1,0] = [8.25,1,0]
...
For m=100 kg load:
F_obs = (100 × c^S) / (7.70 × 0.02)
      = (100 × c^S) / 0.154
      ≈ 650× substrate amplification

With severe 6-9 knots:
φ_max = 0.50 (ceiling from throttling)
For same 100 kg load:
F_obs = (100 × c^S) / (7.70 × 0.50)
      = (100 × c^S) / 3.85
      ≈ 26× substrate amplification
...
2. **Node 6 = bilateral mirror** (I_6=(W/S)×(1-φ))
3. **Node 9 = nucleus overstretch** (T_9=(9/N)×J×(1-φ))
...
10. **Pure ℚ throughout** (zero free parameters)
