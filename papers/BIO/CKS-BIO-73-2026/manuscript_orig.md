...
θ = 0° (vertical):
F = F_max × cos(0°) = F_max × 1 = F_max ✓

θ = 45° (tilted):
F = F_max × cos(45°) = F_max × 0.707 = 71% ✓

θ = 90° (horizontal):
F = F_max × cos(90°) = F_max × 0 = ZERO ✗
...
Metal creates 556× stronger "pull" than normal.
...
- We derive flow equation (F = F_max × cos(θ))
