...
**Series Path:** [@CKS-0-2026] → [@CKS-MATH-0-2026] → [@CKS-MATH-1-2026] → [@CKS-MATH-10-2026] → [@CKS-MATH-104-2026] → [@CKS-BIO-1-2026] → [@CKS-BIO-60-2026] → [@CKS-BIO-61-2026]

**Parent Framework:** [@CKS-0-2026]

**DOI:** 10.5281/zenodo.18878465
...
**Why it works:**
```
Signal sensitivity ∝ antenna length:
...
**The physics:**
```
Ω(θ) = |R_walker(θ) - R_earth,α|

Where:
  Ω = lattice drag
  θ = rotation angle
  R_walker = your orientation
  R_earth,α = earth alpha-dipole
```
