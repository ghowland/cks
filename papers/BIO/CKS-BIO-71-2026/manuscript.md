...
Result:
- Same heart must work 2.5-4× harder
...
γ (Yin, socket): 5/7 × 69 = 49.3
β (Yang, torque): 2/7 × 69 = 19.7
...
Combined:
W_total = W_donut × W_string
W_total = 2.5 × 2 = 5× baseline

Heart must work 5× harder to achieve same output.
...
- W_donut: 2.5× → 1.2× (halved resistance)
```
...
- Heart space expands
- W_string: 2× → 0.5× (quarter resistance)
```
...
- Control group: Minimal change (±2%)
- Statistical significance: p < 0.01
