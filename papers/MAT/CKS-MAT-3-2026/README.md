...
**Series Path:** [@CKS-0-2026] → [@CKS-MATH-0-2026] → [@CKS-MATH-1-2026] → [@CKS-MATH-10-2026] → [@CKS-MATH-104-2026] → [@CKS-MAT-1-2026] → [@CKS-MAT-2-2026] → [@CKS-MAT-3-2026]  

**Zenodo DOI:** 10.5281/zenodo.18647322
...
```bibtex
@article{ CKS-0-2026,
  title={ Anti-Fragile in Cymatics },
