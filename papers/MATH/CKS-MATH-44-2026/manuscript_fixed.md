...
a=1, b=8, c=9
  ...
  rad(1 $\times$ 8 $\times$ 9) = rad(72) = 2 $\times$ 3 = 6
...
a=5, b=27, c=32
  ...
  rad(5 $\times$ 27 $\times$ 32) = rad(4320) = 2 $\times$ 3 $\times$ 5 = 30
...
a=3, b=125, c=128:
  ...
  rad(3 $\times$ 125 $\times$ 128) = 2 $\times$ 3 $\times$ 5 = 30
...
Therefore:
  ...
  c/rad < K $\times$ 144 (for some constant K)

  c < K $\times$ 144 $\times$ rad
