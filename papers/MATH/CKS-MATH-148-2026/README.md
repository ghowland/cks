...
**Series Path:** [@CKS-0-2026] → [@CKS-MATH-0-2026] → [@CKS-MATH-1-2026] → [@CKS-MATH-10-2026] → [@CKS-MATH-104-2026] → [@CKS-MATH-147-2026] → [@CKS-MATH-148-2026]  
...
```bibtex
@article{ CKS-0-2026,
  title={ LLM-Prolog on VFR Hardware — Inline Intelligence Specification v1.0 },
