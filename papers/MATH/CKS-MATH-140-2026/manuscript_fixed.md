...
**Registry:** [@CKS-MATH-140-2026]

**Series Path:** [@CKS-0-2026] → [@CKS-MATH-0-2026] → [@CKS-MATH-1-2026] → [@CKS-MATH-10-2026] → [@CKS-MATH-104-2026] → [@CKS-MATH-139-2026] → [@CKS-MATH-140-2026]
...
Followed by `count  $\times$  depth` VFR pairs at uniform stride of `depth  $\times$  5` bytes.
...
[37, 10_000_000, 1] [v,r] [v,r] [v,r] ... ( $\times$ 10MM)
...
reconstructed value = v0 + v1 $\times$ 32 + v2 $\times$ 32²
...
SCALE   Vd, Va, imm     Vd = Va << (imm  $\times$  5)
...
**SCALE:** Shifts a value by multiple base-32 levels. `SCALE V1, V0, 3` shifts V0 left by 15 bits (3  $\times$  5). Used when converting between batch factors.
...
4. Compute stride: stride = depth  $\times$  5
