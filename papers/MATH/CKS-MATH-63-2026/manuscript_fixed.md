...
Geometric match:
  ...
  Hexagonal coordination  $\checkmark$ 

  120° precise  $\checkmark$ 

  <1 LU via phase-lock  $\checkmark$ 

  

Bilateral structure:

  Two plates  $\checkmark$ 

  S=2 manifold  $\checkmark$ 

  Midplane sensor  $\checkmark$ 

  

Clock sync:

  Modulo-32 aligned  $\checkmark$ 

  65.8 Hz locked  $\checkmark$ 

  N-tick matched  $\checkmark$ 
