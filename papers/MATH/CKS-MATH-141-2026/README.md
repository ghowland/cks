...
**Series Path:** [@CKS-0-2026] → [@CKS-MATH-0-2026] → [@CKS-MATH-1-2026] → [@CKS-MATH-10-2026] → [@CKS-MATH-104-2026] → [@CKS-MATH-140-2026] → [@CKS-MATH-141-2026]  
...
```bibtex
@article{ CKS-0-2026,
  title={ Integer ALU Based Computing — Compiler Specification v1.0 },
