...
**Series Path:** [@CKS-0-2026] → [@CKS-MATH-0-2026] → [@CKS-MATH-1-2026] → [@CKS-MATH-10-2026] → [@CKS-MATH-104-2026] → [@CKS-MATH-5-2026] → [@CKS-MATH-6-2026]  

**Zenodo DOI:** 10.5281/zenodo.18626532
...
```bibtex
@article{ CKS-0-2026,
  title={ The Geometric Origin of π },
