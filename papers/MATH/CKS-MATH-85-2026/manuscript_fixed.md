...
**Series Path:** [@CKS-0-2026] → [@CKS-MATH-0-2026] → [@CKS-MATH-1-2026] → [@CKS-MATH-10-2026] → [@CKS-MATH-104-2026] → [@CKS-MATH-84-2026] → [@CKS-MATH-85-2026]

**Parent Framework:** [@CKS-0-2026]

**DOI:** 10.5281/zenodo.18878867
...
For a polynomial P(x) = a₀∏(x - α$_i$ ), the Mahler measure is:

M(P) = |a₀| ∏ max(1, |α$_i$ |)

**Equivalent definition (logarithmic):**

log M(P) = ∫₀¹ log|P(e^(2 $\pi$ iθ))| dθ
...
Φ$_n$ (x) = cyclotomic polynomial of order n

M(Φ$_n$ ) = 1 (all roots on unit circle)
...
θ = 2 $\pi$ n/32, n = 0,1,...,31 (discrete points)
...
**For polynomial P(x) = ∏(x - α$_i$ ):**

**If |α$_i$ | = 1:** Root on unit circle

Pure rotation (no expansion)

Cyclotomic behavior

**If |α$_i$ | > 1:** Root outside unit circle

Expansion (substrate grows)

Non-cyclotomic behavior

**If |α$_i$ | < 1:** Root inside unit circle
...
**Cyclotomic polynomial Φ$_n$ (x):**

Φ$_n$ (x) = ∏(x - e^(2 $\pi$ ik/n))
...
10 complex roots, all with |α$_i$ | ≈ 1.176... or |α$_i$ | < 1.
...
M(L) = |leading coeff| · ∏ max(1, |α$_i$ |)

 = 1 · ∏(roots outside unit circle) |α$_i$ |
...
**Mahler measure for P(x₁, ..., x$_n$ ):**

M(P) = exp(∫...∫ log|P(e^(2 $\pi$ iθ₁), ..., e^(2 $\pi$ iθ$_n$ ))| dθ₁...dθ$_n$ )
...
-  $\pi$ , e, φ → geometric closure ratios
