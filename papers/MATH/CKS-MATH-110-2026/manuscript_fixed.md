...
Claim: x = √2 (irrational  $\mathbb{R}$ -value)
...
To verify x = x_true (where x_true ∈  $\mathbb{R}$ \ $\mathbb{Q}$ ):
...
- x ∈  $\mathbb{R}$ \ $\mathbb{Q}$  (irrational value)
...
(3) x ∈  $\mathbb{R}$ \ $\mathbb{Q}$  has infinite bits
...
c² is  $\mathbb{R}$ -value (if c ∈  $\mathbb{R}$ )
...
Question: Is a = b? (where a,b ∈  $\mathbb{R}$ )
...
x ∈  $\mathbb{R}$ \ $\mathbb{Q}$ : ∞ bits required
...
Maximum information: I_max = C  $\times$  t bits
...
Show: Value x ∈  $\mathbb{R}$ \ $\mathbb{Q}$ 
...
For: Arbitrary a, b ∈  $\mathbb{R}$ \ $\mathbb{Q}$ 
...
Show: Study value x ∈  $\mathbb{R}$ \ $\mathbb{Q}$ 
...
Current status:
 ...
 $\checkmark$  All knowledge involves finite precision

 $\checkmark$  All memory stores finite bits

 $\checkmark$  All communication transmits finite data

 $\checkmark$  All verification uses finite comparison

 $\checkmark$  All science uses effective  $\mathbb{Q}$ -values

 $\checkmark$  All mathematics proven in finite steps

 $\checkmark$  Knowledge requires  $\mathbb{Q}$ 
...
-  $\mathbb{R}$ -values have infinite bits (I(x)=∞)
...
-  $\mathbb{Q}$ -values have finite bits ([V,F,R]℘)
