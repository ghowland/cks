...
But LERP over multiple cycles:
  Simple correction: ~10 cycles = 10 × 32 ticks ≈ 16 ms
  
Wait, that's too fast. Where does 10 seconds come from?

Answer: Higher-level soliton cycle
  Body-level refresh: ~(0.5, 1, 0) Hz (π-flip)
  LERP iterations: ~20 flips
  Total: 20 × (2, 1, 0) seconds = (40, 1, 0) seconds maximum
...
```
Substrate tick: (50, 1, 0) μs
Word cycle: (32, 1, 0) ticks = ~1.6 ms
Body π-flip: ~(2, 1, 0) seconds (0.5 Hz)
...
Protocol:
  ...
  2. Maintain vertical for 32s cycles × N sessions
