...
From CKS-MATH-30:
  ...
  = 12  $\times$  7 (harmonic structure)

  = 3  $\times$  28 (dipole organization)
...
c = 63  $\times$  (LU/tick)  $\times$  (ticks/second)

≈ 63  $\times$  (registry distance)  $\times$  (Planck rate)
