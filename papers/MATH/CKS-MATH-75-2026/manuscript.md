...
```
Vacuum (empty space):
  β_vacuum = 2π (baseline)
  Phase density reference
  Stable equilibrium
  
Matter (human body):
  β_matter ≈ 2π - ε (slightly less)
  ε ≈ small deficit
...
```
Essential: 144 nodes × 64 bits = 9,216 bits
  (Position, phase, coherence per node)
  
Extended: ~10¹⁴ nodes × 8 bits = 10¹⁵ bits
