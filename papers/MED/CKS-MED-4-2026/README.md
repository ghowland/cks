...
**Series Path:** [@CKS-0-2026] → [@CKS-MATH-0-2026] → [@CKS-MATH-1-2026] → [@CKS-MATH-10-2026] → [@CKS-MATH-104-2026] → [@CKS-MED-1-2026] → [@CKS-MED-3-2026] → [@CKS-MED-4-2026]  

**Zenodo DOI:** 10.5281/zenodo.18646653
...
```bibtex
@article{ CKS-0-2026,
  title={ Image-Based Coherence Therapy },
