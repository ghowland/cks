...
**Series Path:** [@CKS-0-2026] → [@CKS-MATH-0-2026] → [@CKS-MATH-1-2026] → [@CKS-MATH-10-2026] → [@CKS-MATH-104-2026] → [@CKS-BODY-1-2026] → [@CKS-BODY-11-2026] → [@CKS-BODY-12-2026]

**Parent Framework:** [@CKS-0-2026]

**DOI:** 10.5281/zenodo.18878515
...
Antenna type:
  ...
  - Near-field dominant (<λ/2 $\pi$  range)
...
PLV(t) = | $\langle$ exp(i[φ₁(t) - φ₂(t)]) $\rangle$ |
...
Qigong masters:
  ...
  Peak: 31.25  $\pm$  0.5 mHz

  Q: 150  $\pm$  30

  Amplitude: 15  $\pm$  5 pT
...
Contact: PLV rises to 0.7  $\pm$  0.1 (60 sec)

Treatment: PLV = 0.65  $\pm$  0.1 (sustained)

Post: PLV decays to 0.35  $\pm$  0.1 (5 min)
...
Data points:
  ...
  r = 0.5: PLV = 0.70  $\pm$  0.1

  r = 1.0: PLV = 0.35  $\pm$  0.08

  r = 2.0: PLV = 0.10  $\pm$  0.05

  r = 5.0: PLV = 0.02  $\pm$  0.02
...
NOT:
   ...
   $\times$  Chemical intervention only

   $\times$  Mechanical repair only

   $\times$  Placebo/belief only

   $\times$  Mystical energy transfer

  

BUT:

   $\checkmark$  Master-slave phase-locking

   $\checkmark$  Information pattern transfer

   $\checkmark$  Hardware-level reset

   $\checkmark$  Measurable EM coupling

   $\checkmark$  Trust-dependent protocol
