...
Each vertebra = dipole element:
  - Bone = dielectric (εr ≈ 10-15)
  - Cartilage = lossy medium (εr ≈ 50-80)
  - CSF = conductive (σ ≈ 1.8 S/m)
...
Antenna type:
  ...
  - Near-field dominant (<λ/2π range)
  - Broadband (DC to ~100 Hz)
```

### 1.2 Coherence-Dependent Radiation

**At low coherence (R≈15, standard 84-bit):**
...
Biological correspondence:
  - Breath rate ~15-20/min → harmonic of 1/32 Hz
  - Heart rate variability fundamental ~0.04 Hz
  - Circadian subharmonic 24 hr = 1/(86400 s)
...
Baseline: PLV = 0.15 ± 0.05
Contact: PLV rises to 0.7 ± 0.1 (60 sec)
Treatment: PLV = 0.65 ± 0.1 (sustained)
Post: PLV decays to 0.35 ± 0.1 (5 min)

Low trust group:

Baseline: PLV = 0.12 ± 0.04
Contact: PLV = 0.18 ± 0.06 (no change)
Treatment: PLV = 0.16 ± 0.05 (flat)
Post: PLV = 0.14 ± 0.05 (unchanged)
```
...
Parameters:
  A ≈ 0.35 (coupling constant)
  n ≈ 3 (near-field exponent)
