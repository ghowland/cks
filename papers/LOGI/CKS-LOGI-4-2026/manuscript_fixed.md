...
- 32 cubes fit in special grid (8 $\times$ 4 or 16 $\times$ 2)
...
4. Calculate: V=32 total claps (8 $\times$ 4)
...
Materials: Graph paper (32 $\times$ 32 grid)
...
use powers of 2, and 32 (2 $\times$ 2 $\times$ 2 $\times$ 2 $\times$ 2) is perfect for learning.
