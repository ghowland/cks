...
|---|---|
| **D=3, S=2,  $\mathbb{Q}$ ** | Three axioms: 3D, bilateral symmetry, rational substrate |
...
γ (socket) = 49.3 (5/7  $\times$  69)

β (torque) = 19.7 (2/7  $\times$  69)
...
Bilateral lag: J  $\times$  S = 7.71  $\times$  2 = 15.42 ≈ 15.19ms
