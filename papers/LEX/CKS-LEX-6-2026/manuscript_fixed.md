...
- Wing-lattice geometry (6 wings  $\times$  3 pairs = 18 dark matter units)
...
- N₃ at (0.5, √3/2, 0) [approximated in  $\mathbb{Q}$ ]
...
J = ln(7)/ln(32)  $\times$  [packing factor]
...
Geometric: 6 $\times$ 9 = 54, 6+9 = 15, 69/Δ19 ≈ 3.63
...
Total per node: 6 wings  $\times$  3 units = 18 units
...
- N ∈  $\mathbb{N}$  (natural numbers only)

- W ∈ {0, 1, 2, 3} (at most 3 wing pairs)

- Positions ∈  $\mathbb{Q}$ ³ (rational coordinates only)
...
- Testable ratios (dark matter 3:1)  $\checkmark$ 
