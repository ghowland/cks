...
ΔJ ≈ [192541,25000,0] × [1,2,0]
    ≈ 3.85× local impedance

DAILY IMPACT:

8 hours slouched:
ε_accumulated = [8,1,0] × 8 hours
                × (3600 s/hr) / τ
...
≈ 2.8× improvement minimum

OVERNIGHT IMPACT:

8 hours back-sleep:
Total venting = [11.2,1,0] × 8hr
              × jubilee_cycles
