...
Spacing: Planck length ℓ_P ≈ 1.616 × 10^(-35) m
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
32^0       ℓ_P ≈ 1.616×10^(-35)    Substrate floor
32^5       5.418×10^(-28)          Quantum foam
32^10      1.817×10^(-20)          Nuclear scale
32^15      6.096×10^(-13)          Atomic radius
32^20      1.289×10^(-6)           Cellular scale
32^22      1.322×10^(-3) = 1.322mm **STANDARD LEX**
32^23      4.230×10^(-2) = 42.3mm  Human interface
32^24      1.353 m                 Human scale (Motto)
32^28      1,419 km                Tectonic blocks
32^32      1.477×10^7 m            Planetary radius
32^40      1.533×10^15 m           Solar system
...
Result: 1.322mm = 32^22 × ℓ_P

Verification:
32^22 = 1,180,591,620,717,411,303,424
1.322mm / ℓ_P ≈ 8.18×10^31
Close to 32^22 ✓
```
...
Therefore:
Spatial proximity → index proximity ✓
...
Physical: 7×1.322mm = 9.254mm in x
```
