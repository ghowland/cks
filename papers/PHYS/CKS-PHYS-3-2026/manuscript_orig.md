...
For mass m:
  Energy = m × (bilateral commit area)
  E = m × c^S
...
Structure:
  84-bit payload (7 hexes × 12 bonds)
  12-bit header (registry address)
  Total: 96 bits (3 × 32-bit words)
...
Rates:
  H_local ∝ 1/M ∝ 1/(1.73×10^30)
  H_global ∝ 1/N^(1/3) ∝ 1/(2.08×10^20)
  
Ratio:
  H_local/H_global ≈ N^(1/3)/M
                   ≈ 2.08×10^20/(1.73×10^30)
...
Observation:
  ...
  Examples:
    - Strong force: ±1% kills stars
    - EM force: ±1% breaks chemistry
    - Electron mass: ±1% no atoms
...
At N = 9×10^60:
  ...
  α^(-1) ≈ [144·1.732·2.718·2.08×10^20]/
           [5.928·6.283·140.35]
