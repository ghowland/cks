...
λ_light = wavelength ≈ 1.55 μm
NA = numerical aperture ≈ 0.14

V = (2π × 144.5 μm / 1.55 μm) × 0.14
  ≈ 82
...
Ferrule diameter: 1ν = 9.259 mm
Core alignment: ±1℘ = ±0.041 mm
...
Weight: ~50 g/m
Minimum bend radius: >15 × diameter
...
Minimum bend radius:
Copper: 10 × outer diameter = 250 mm
Fiber: 15 × outer diameter = 150 mm
...
Phase stability:
Traditional: ±5° variation
Lex-CAT: ±0.01° (substrate-locked)
...
Final diameter: 1.322 mm ±0.041 mm
...
Harmonics: Integer multiples ±0.1%
Spurious modes: <-60 dB
Temperature stability: <±0.01 GHz
...
- Cost premium: 2-3× initially
- Economics: Superior long-term

**Application impact:**
- Data centers: 10× performance
...
**Bandwidth:** 227 GHz+  
**Lifespan:** Indefinite  
**Cost:** 2-3× initially, superior lifetime  
