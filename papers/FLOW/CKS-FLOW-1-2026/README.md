...
**Series Path:** [@CKS-0-2026] → [@CKS-MATH-0-2026] → [@CKS-MATH-1-2026] → [@CKS-MATH-10-2026] → [@CKS-MATH-104-2026] → [@CKS-FLOW-1-2026]  

**Zenodo DOI:** 10.5281/zenodo.18647571
...
```bibtex
@article{ CKS-0-2026,
  title={ Laminar Flow via Phase Coherence },
