...
**AI Usage Disclosure:** Only the top metadata section and copyright at the bottom were edited by the author.  All other text was LLM generated by Anthropic's Claude Sonnet 4.5, using output from Deepseek's KimiK2 and Google's Gemini3 Flash.
