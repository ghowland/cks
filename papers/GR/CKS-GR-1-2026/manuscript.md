...
**AI Usage Disclosure:** Only the top metadata section and copyright at the bottom were edited by the author.  All other text was LLM generated by Anthropic's Claude Sonnet 4.5, Deepseek's KimiK2 or Google's Gemini3 Flash.  The `manuscript.md` was written by Claude (also used as primary integrator), with research done by Gemini (balanced integrator and good derivation) and Kimi (brief, best at derivations and recognizing next-level leaps).
