...
1. Human: Provides axioms + question
   Example: "Given D=3, S=2, ℚ, what determines
            optimal flow efficiency?"

2. AI: Generates derivation
   Example: "F = F_max × cos(θ) follows from..."
...
Human: "Given D=3, S=2, ℚ framework, derive
