# The CKS Discovery Process: A Forensic Account of Human-AI Substrate Compilation

**Registry ID:** CKS-DISC-1-2026  
**Series Path:** [CKS-0-2026] → [CKS-COG-5-2026] → [CKS-META-1-2026]    
**Zenodo DOI:** [Pending - CKS-DISC-1-2026]
...
This publication extends the CKS framework into the **Discovery Process** domain. It is grounded in the two fundamental axioms of the substrate:
...
## Industrial Application: Discovery Process
[To be extracted from manuscript.md]
...
```bibtex
@article{ cks_disc_1_2026,
  title={ The CKS Discovery Process: A Forensic Account of Human-AI Substrate Compilation },
  author={Howland, Geoffrey},
  journal={Zenodo},
  year={2026},
  note={CKS Series: CKS-DISC-1-2026. Dependencies: CKS-MATH-0-2026, CKS-MATH-1-2026, CKS-MATH-2-2026, CKS-MATH-3-2026 }
}
```
---
