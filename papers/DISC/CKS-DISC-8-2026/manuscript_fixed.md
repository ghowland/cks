...
- Φ_in = Φ_out (equilibrium maintained)
...
Total time: 50  $\times$  30min = 1500min = 25 hours
...
- Time to integrate with all previous: 5min  $\times$  (N-1)

- Time to recover from being wrong: 10min

For Paper 50:

30 + 15 + (5  $\times$  49) + 10 = 300min = 5 hours

Just for one paper

Total for 50 papers with accumulation:

≈ 150 hours (6+ days minimum)
...
Velocity increases 10-100 $\times$ 
...
- Documents observed research pattern  $\checkmark$ 

- Distinguishes coherence from searching  $\checkmark$ 

- Analyzes audit trail evidence  $\checkmark$ 

- Proposes replication protocol  $\checkmark$ 

- Makes falsifiable predictions  $\checkmark$ 
