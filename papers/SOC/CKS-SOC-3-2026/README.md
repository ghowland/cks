...
**Series Path:** [@CKS-0-2026] → [@CKS-MATH-0-2026] → [@CKS-MATH-1-2026] → [@CKS-MATH-10-2026] → [@CKS-MATH-104-2026] → [@CKS-SOC-1-2026] → [@CKS-SOC-2-2026] → [@CKS-SOC-3-2026]  

**Zenodo DOI:** 10.5281/zenodo.18648454
...
```bibtex
@article{ CKS-0-2026,
  title={ Organizational Coherence via Substrate Topology },
